...
logs_dir= "/home/iiti/Desktop/SID/Fully-convolutional-neural-network-FCN-for-semantic-segmentation-Tensorflow-implementation-master/logs/"# "path to logs directory where trained model and information will be stored"
