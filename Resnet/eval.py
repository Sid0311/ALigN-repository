...
tf.app.flags.DEFINE_string('test_image_root', '/media/D/SID/Resnet18/resnet-18-tensorflow-master/val/ILSVRC2012_img_val/', """Path to the root of ILSVRC2012 test images""")
...
tf.app.flags.DEFINE_string('checkpoint', '/media/D/SID/Resnet18/resnet-18-tensorflow-master/init/model.ckpt-25000', """Path to the model checkpoint file""")
tf.app.flags.DEFINE_string('output_file', './alexnet_baseline_2/', """Path to the result pkl file""")
