...
tf.app.flags.DEFINE_string('train_image_root', '/media/D/SID/Resnet18/train/', """Path to the root of ILSVRC2012 training images""")
tf.app.flags.DEFINE_string('val_dataset', 'scripts/val.txt', """Path to the test dataset list file""")
tf.app.flags.DEFINE_string('val_image_root', '/media/D/SID/Resnet18/resnet-18-tensorflow-master/val/ILSVRC2012_img_val/', """Path to the root of ILSVRC2012 test images""")
...
tf.app.flags.DEFINE_string('lr_step_epoch', "10", """Epochs after which learing rate decays""")
tf.app.flags.DEFINE_float('lr_decay', 0.1, """Learning rate decay factor""")
tf.app.flags.DEFINE_boolean('finetune', True, """Whether to finetune.""")

# Training Configuration
tf.app.flags.DEFINE_string('train_dir', '/media/D/SID/Resnet18/resnet-18-tensorflow-master/', """Directory where to write log and checkpoint.""")
tf.app.flags.DEFINE_integer('max_steps', 100000, """Number of batches to run.""")
tf.app.flags.DEFINE_integer('display', 100, """Number of iterations to display training info.""")
tf.app.flags.DEFINE_integer('val_interval', 1000, """Number of iterations to run a val""")
tf.app.flags.DEFINE_integer('val_iter', 5, """Number of iterations during a val""")
...
tf.app.flags.DEFINE_string('basemodel', "./init/model.ckpt-25000", """Base model to load paramters""")
